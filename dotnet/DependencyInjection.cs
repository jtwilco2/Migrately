...
namespace Sabio.Web.StartUp
{
    public class DependencyInjection
    {
        public static void ConfigureServices(IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddSingleton<IDiplomaticMissionService, DiplomaticMissionService>();
            ...
            services.AddSingleton<IImmigrantVisaFeeService, ImmigrantVisaFeeService>();
            ...
            services.AddSingleton<ISiteRefChartService, SiteRefChartService>();
